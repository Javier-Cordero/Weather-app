...
export default function App() {
  ...
  return (
    <div className="w-screen lg:flex">
      ...
      <Container units={units} setUnits={setUnits} location={location} setSimbolo={setSimbolo} simbolo={simbolo} iconMap={iconMap} windSpeed={clima.windSpeed} windDegree={clima.windDegree} humidity={clima.humidity} visibility={clima.visibility} air={clima.air} />
    </div>
  )
}